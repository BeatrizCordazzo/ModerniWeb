...
$uploadDir = __DIR__ . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'showcase';
...
$uniqueName = 'showcase_' . bin2hex(random_bytes(8)) . '.' . $extension;
...
$relativePath = 'uploads/showcase/' . $uniqueName;
